...
export const archivePageController = (() => {
    ...
    const controller = {
        init() {
            ...
            if (!list || !yearList || !pagination || !paginationSection)
                return;
            this.labels = {
        ...
        createPostItem(post) {
            ...
            meta.append(createElement('span', 'archive-page-item-category', post.primaryCategory || this.labels.uncategorized), createElement('span', 'archive-page-item-divider', '/'), createElement('span', 'archive-page-item-date', post.dateLabel));
        ...
        renderPagination(totalPages) {
            ...
            this.pagination.appendChild(this.createPageButton(this.currentPage + 1, this.labels.next, 'archive-page-extend next', this.currentPage === totalPages, 'fa-chevron-right'));
        },
